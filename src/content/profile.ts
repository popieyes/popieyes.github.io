...
export const profile: Profile = {
  ...
  intro:
    'I build renderers and the tooling around them. Right now I work as a Research Engineer at MSLab, Rey Juan Carlos University, on garment simulation and 3D scene vectorization. Outside the lab I write engines from scratch, because borrowing one never taught me what I wanted to know.',
